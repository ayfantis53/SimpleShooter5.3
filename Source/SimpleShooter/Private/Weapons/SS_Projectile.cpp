...
ASS_Projectile::ASS_Projectile()
{
	...
	projectile_movement_comp_ = CreateDefaultSubobject<UProjectileMovementComponent>(TEXT("Projectile Movement Component"));
	projectile_movement_comp_->MaxSpeed     = 2000.f;
	projectile_movement_comp_->InitialSpeed = 2000.f;
}
