...
#include "SS_Gun_Enemy_rifle.generated.h"

/**
 * 
 */
UCLASS()
class SIMPLESHOOTER_API ASS_Gun_enemy_rifle : public ASS_Gun_base
{
	GENERATED_BODY()
...
private:
	...
	/// @brief:
	FString rifle_skeleton_path_{ "SkeletalMesh'/Game/AssetPacks/ShooterGame/Weapons/1Rifle/Rifle_Enemy.Rifle_Enemy'" };
};
